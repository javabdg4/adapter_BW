...
import AdapterProj.Adapt.SocketAdapter;
import AdapterProj.Adapt.SocketClassAdapterImpl;
import AdapterProj.Adapt.SocketObjAdapterImpl;
import AdapterProj.Adapt.Volt;
...
public class Main {
    ...
    public static void objectAdapter(){
        SocketAdapter socketAdapter = new SocketObjAdapterImpl();
